...
async def adm_ban_init(call: CallbackQuery, state: FSMContext):
    ...
    await call.message.edit_text("Ban berish uchun foydalanuvchi ID sini yuboring:")
...
async def adm_unban_init(call: CallbackQuery, state: FSMContext):
    ...
    await call.message.edit_text("Bandan olish uchun foydalanuvchi ID sini yuboring:")
