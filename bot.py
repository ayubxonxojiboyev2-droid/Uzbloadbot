...
if not BOT_TOKEN:
    raise RuntimeError("BOT_TOKEN environment variable topilmadi! Render -> Environment bo'limiga qo'shing.")
if not ADMIN_SECRET:
    raise RuntimeError("ADMIN_SECRET environment variable topilmadi! Render -> Environment bo'limiga qo'shing.")
